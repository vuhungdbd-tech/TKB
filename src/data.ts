...
export const initialSubjects: Subject[] = [
  { id: 's1', name: 'Toán', lessonsPerWeek: 4, type: 'main', allowDouble: true, session: 'all', hasExam: true },
  { id: 's2', name: 'Ngữ Văn', lessonsPerWeek: 4, type: 'main', allowDouble: true, session: 'all', hasExam: true },
  { id: 's3', name: 'Tiếng Anh', lessonsPerWeek: 3, type: 'main', allowDouble: false, session: 'all', hasExam: true },
  { id: 's4_1', name: 'KHTN (Lý)', lessonsPerWeek: 1, type: 'integrated', allowDouble: false, session: 'all', hasExam: true },
  { id: 's4_2', name: 'KHTN (Hóa)', lessonsPerWeek: 1, type: 'integrated', allowDouble: false, session: 'all', hasExam: true },
  { id: 's4_3', name: 'KHTN (Sinh)', lessonsPerWeek: 2, type: 'integrated', allowDouble: true, session: 'all', hasExam: true },
  { id: 's5_1', name: 'LS&ĐL (Sử)', lessonsPerWeek: 2, type: 'integrated', allowDouble: true, session: 'all', hasExam: true },
  { id: 's5_2', name: 'LS&ĐL (Địa)', lessonsPerWeek: 1, type: 'integrated', allowDouble: false, session: 'all', hasExam: true },
  { id: 's6', name: 'GDCD', lessonsPerWeek: 1, type: 'sub', allowDouble: false, session: 'all' },
  { id: 's7', name: 'Thể dục', lessonsPerWeek: 2, type: 'sub', allowDouble: false, session: 'all' },
  { id: 's8', name: 'Nghệ thuật', lessonsPerWeek: 2, type: 'sub', allowDouble: false, session: 'all' },
  { id: 's9', name: 'Tin học', lessonsPerWeek: 2, type: 'sub', allowDouble: false, session: 'all' },
  { id: 's10', name: 'Công nghệ', lessonsPerWeek: 1, type: 'sub', allowDouble: false, session: 'all' },
];
